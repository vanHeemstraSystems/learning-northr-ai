...
A structured learning repository for [northr.ai](https://northr.ai/) — an adaptive AI planning system that lets you define your direction once and handles the weekly details automatically.
